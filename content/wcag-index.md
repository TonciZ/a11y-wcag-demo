...
# WCAG 2.2 Checkpoint Index

Master list of checkpoints implemented or planned on this site.
Level A and AA only. Criteria excluded from this site are noted below.
...
- id: 1-3-1
  ...
  level: A
  principle: Perceivable
  slug: 1-3-1-info-relationships
  summary: Structure and relationships conveyed through presentation must also be programmatically determinable or available in text.
  status: implemented
